DROP DATABASE IF EXISTS saving_quest;
CREATE DATABASE saving_quest;

USE saving_quest;
DROP TABLE IF EXISTS memberMissions;
...
-- Create MemberMissions
CREATE TABLE memberMissions (
    member_mission_id INT AUTO_INCREMENT PRIMARY KEY,
    member_id INT,
    mission_id INT,
...
-- Create Missions
INSERT INTO missions (mission_title, mission_description, exp_point) VALUES
